...
const items = [
  {
    img: "https://www.patra-jasa.com/wp-content/uploads/2023/03/1.-Cover-Urbano-Apartment--scaled.jpg",
    href: "/products/property-1",
  },
  {
    img: "https://www.patra-jasa.com/wp-content/uploads/2023/03/Patraland-Amarta-Apartment-3D-1.jpg",
    href: "/products/property-1",
  },
  {
  ...
  {
    img: "https://www.patra-jasa.com/wp-content/uploads/2023/03/soho_park_landscape.jpg",
    href: "/products/property-1",
  },
];

export default function PropertiJualPage() {
  const { t } = useI18n();
      ...
      <div className="relative z-10">
        ...
        <section className="relative flex min-h-[60vh] items-end overflow-hidden pb-16 pt-32">
          <div className="absolute inset-0">
            ...
            <img
              src="https://patra-jasa.com/wp-content/uploads/2021/06/sell.jpg"
              alt="Properti Jual"
          ...
          <div className="container-site relative z-10">
            ...
            >
              Property · <span className="text-white">Properti Jual</span>
            </motion.p>
            <motion.h1
              ...
              {items.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-6">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-ash">{t(`pj.${i}.desc`)}</p>
                  </div>
                </motion.a>
              ))}
            </div>
