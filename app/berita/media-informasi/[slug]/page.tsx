...
export default function ArticlePage({ params }: PageProps) {
  ...
  const title = article.titleKey ? t(article.titleKey as any) : article.title;
      ...
      <div className="relative z-10">
        ...
        <section className="relative flex min-h-[55vh] items-end overflow-hidden pb-16 pt-32 bg-white">
          <div className="container-site relative z-10">
            ...
            >
              <ArrowLeft className="h-3.5 w-3.5" /> {t("common.kembaliKe")}
            </Link>
        ...
        <section className="section-pad border-t border-ash/10 bg-sand">
          <div className="container-site max-w-4xl">
            ...
            <div className="mt-10">
              ...
              >
                <ArrowLeft className="h-4 w-4" /> {t("common.kembaliKe")}
              </Link>
            </div>
          </div>
        </section>
